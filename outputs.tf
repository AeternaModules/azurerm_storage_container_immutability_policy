output "storage_container_immutability_policies_id" {
  ...
  value       = { for k, v in azurerm_storage_container_immutability_policy.storage_container_immutability_policies : k => v.id if v.id != null && length(v.id) > 0 }
}
output "storage_container_immutability_policies_immutability_period_in_days" {
  ...
  value       = { for k, v in azurerm_storage_container_immutability_policy.storage_container_immutability_policies : k => v.immutability_period_in_days if v.immutability_period_in_days != null }
}
output "storage_container_immutability_policies_locked" {
  ...
  value       = { for k, v in azurerm_storage_container_immutability_policy.storage_container_immutability_policies : k => v.locked if v.locked != null }
}
output "storage_container_immutability_policies_protected_append_writes_all_enabled" {
  ...
  value       = { for k, v in azurerm_storage_container_immutability_policy.storage_container_immutability_policies : k => v.protected_append_writes_all_enabled if v.protected_append_writes_all_enabled != null }
}
output "storage_container_immutability_policies_protected_append_writes_enabled" {
  ...
  value       = { for k, v in azurerm_storage_container_immutability_policy.storage_container_immutability_policies : k => v.protected_append_writes_enabled if v.protected_append_writes_enabled != null }
}
output "storage_container_immutability_policies_storage_container_resource_manager_id" {
  ...
  value       = { for k, v in azurerm_storage_container_immutability_policy.storage_container_immutability_policies : k => v.storage_container_resource_manager_id if v.storage_container_resource_manager_id != null && length(v.storage_container_resource_manager_id) > 0 }
}
